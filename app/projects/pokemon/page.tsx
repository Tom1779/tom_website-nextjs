  ...
  return (
    <main className="relative z-0 text-white min-h-screen">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-20 pb-16 max-w-4xl mx-auto">
        ...
        <div className="flex gap-4 mt-8 flex-wrap justify-center">
          <a
            ...
            className="px-5 py-2.5 bg-amber-300 hover:bg-amber-400 text-gray-900 font-semibold rounded-lg text-sm transition-colors duration-200"
          >
            Open in Colab →
          </a>
          <Link
      ...
      <section className="max-w-4/6 mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {techStack.map((tech) => (
            ...
            >
              <p className="text-white font-semibold text-sm mb-1">{tech.label}</p>
      ...
      <section className="max-w-4/6 mx-auto px-6 py-16">
        ...
        {/* Model layers */}
        <h3 className="text-white text-base font-semibold mb-4">Model Architecture (7 Layers)</h3>
        <div className="flex flex-col gap-2">
          {modelLayers.map((item, i) => (
            <div
              key={item.layer}
              className="flex items-start gap-4 bg-white/5 border border-white/10 rounded-xl px-4 py-3"
            >
              <span className="text-amber-300 font-mono text-xs mt-0.5 min-w-[2rem]">
                {String(i + 1).padStart(2, "0")}
              </span>
              <div>
                <p className="text-white text-sm font-semibold">{item.layer}</p>
      ...
      <section className="max-w-4/6 mx-auto px-6 py-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          <div className="flex-1 bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <p className="text-amber-300 text-4xl font-bold mb-1">~96%</p>
            <p className="text-gray-400 text-sm">Peak test accuracy</p>
          </div>
          <div className="flex-1 bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <p className="text-amber-300 text-4xl font-bold mb-1">88–96%</p>
            <p className="text-gray-400 text-sm">Accuracy across runs</p>
          </div>
          <div className="flex-1 bg-white/5 border border-white/10 rounded-xl p-6 text-center">
            <p className="text-amber-300 text-4xl font-bold mb-1">4</p>
            <p className="text-gray-400 text-sm">Pokémon species classified</p>
          </div>
        </div>
      ...
      {/* Conclusion */}
      <section className="max-w-4/6 mx-auto px-6 py-16 pb-20">
        <h2 className="text-amber-300 text-xs font-semibold tracking-widest uppercase mb-4">
          Conclusion
        </h2>
        <p className="text-gray-300 text-base leading-relaxed mb-4">
